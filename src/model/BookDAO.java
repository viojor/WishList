...
public class BookDAO extends PurchasableItemDAO<Book> {
    ...
    public void createTable() {
        ...
        try {
            ...
            st.executeUpdate("CREATE TABLE " + BOOKS_TABLE_NAME + " (id INT PRIMARY KEY auto_increment, cover VARCHAR(" + STRINGS_MAX_SIZE + ")," +
                    " name VARCHAR(" + STRINGS_MAX_SIZE + "), price VARCHAR(" + STRINGS_MAX_SIZE + "), author VARCHAR(" + STRINGS_MAX_SIZE + ")," +
                    " pages_number INT, ISBN VARCHAR(" + STRINGS_MAX_SIZE + "), publication_date VARCHAR(" + STRINGS_MAX_SIZE + ")," +
                    " state VARCHAR(" + STRINGS_MAX_SIZE + "))");
