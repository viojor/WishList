...
public class FormValidator {
    ...
    public boolean isStringValueNotOverflowing(JTextField field){

        if(field.getText().length() > PurchasableItemDAO.STRINGS_MAX_SIZE){

            final_error_msg += "The field " + field.getName() + " cant have more than " + PurchasableItemDAO.STRINGS_MAX_SIZE + " characters \n";
            return false;
        }
        return true;
    }
